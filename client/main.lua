...
AddEventHandler('esx_basicneeds:onDrinkDrPepper', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'ng_proc_sodacan_01a' --ng_proc_sodacan_01a
		IsAnimated = true
...
AddEventHandler('esx_basicneeds:onDrinkSoda', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'v_res_tt_can03' --ng_proc_sodacan_01a
		IsAnimated = true
...
AddEventHandler('esx_basicneeds:onDrinkIceTea', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'v_res_fa_pottea' --ng_proc_sodacan_01b
		IsAnimated = true
...
AddEventHandler('esx_basicneeds:onDrinkCoffe', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'p_ing_coffeecup_01' --ng_proc_sodacan_01a
		IsAnimated = true
...
AddEventHandler('esx_basicneeds:onDrinkBeer', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'v_res_tt_can02'
		IsAnimated = true
...
AddEventHandler('esx_basicneeds:onDrinkWhisky', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'prop_drink_whisky' -- anterior: prop_cs_whiskey_bottle
		IsAnimated = true
...
--- Té de María
RegisterNetEvent('esx_basicneeds:onSmokeJoint')
AddEventHandler('esx_basicneeds:onSmokeJoint', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'p_weed_bottle_s' --ng_proc_sodacan_01a
		IsAnimated = true
...
--- MDPV
RegisterNetEvent('esx_basicneeds:onConsumeMDPV')
AddEventHandler('esx_basicneeds:onConsumeMDPV', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'p_weed_bottle_s' --ng_proc_sodacan_01a
		IsAnimated = true
